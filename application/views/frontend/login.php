...
<head>
    ...
    <meta name="author" content="AGUS SALIM HADJRIANTO">
...
<div class="container">
    ...
    <form class="form-signin" method="post" action="<?php echo site_url('process.aspx') ?>">
        ...
        <div class="login-wrap">
            ...
            <br>
            <center><a class="" href="<?php echo site_url() ?>"> <<< Kembali</a> </center>
